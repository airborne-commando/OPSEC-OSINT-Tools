...
2. **Anonymity**:  
   ...
   - Pitfalls: you need to use TOR and Mullvad separately for maximum Anonymity, use a [Virtual Machine](https://github.com/airborne-commando/OPSEC-OSINT-Tools/blob/main/opsec.md#spoofing-fake-email-generation).
...
| **reddit**   | r00m101.com         | [r00m101](https://r00m101.com/)       | Get Info from a active or deleted reddit account                                       | Pricing for full scope possibly
