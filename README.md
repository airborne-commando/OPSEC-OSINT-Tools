...
| **Archival** | | | | |
| megalodon | Search and get Uotaku | url or free words | Japanese, web archive citation | [megalodon](https://megalodon.jp/) |
| ghostarchive | Search archive | archive or find existing | see the [about](https://ghostarchive.org/about.html) | [ghostarchive](https://ghostarchive.org/) |
| archive.ph | search existing archives | get a new archive | Free, donations are optional (XMR) also seems to ddos websites avoid for the time being and check for updates. You can get rate limited./[1](https://gyrovague.com/2026/02/01/archive-today-is-directing-a-ddos-attack-against-my-blog/)/[2](https://en.wikipedia.org/wiki/Wikipedia:Requests_for_comment/Archive.is_RFC_5)/[3](https://www.heise.de/en/news/Archive-today-Operator-uses-users-for-DDoS-attack-11171455.html)/[4](https://www.google.com/search?q=archive.today&tbm=nws&source)/[5](https://www.reddit.com/search/?q=archive.today&type=posts&t=week) | [archive.ph](https://archive.ph/). |
| Wayback Machine | Search for snapshots / archive | Get a snapshot or archive | may not let you archive a domain (which can be good)/[1](https://wiki.archiveteam.org/index.php?title=List_of_websites_excluded_from_the_Wayback_Machine) | [Wayback Machine](https://web.archive.org/) |
| **Genealogy & Records** | | | | |
...
| github-recon | commit history and others | possible email address | may be the real email address, you can do so manually with <commit-string>.patch | [GitHub](https://github.com/anotherhadi/github-recon) |
...
here is an example of a rule that is copied (may be expired as of writing this, use a text editor):
...
> [!WARNING] 
> Do not use additional extensions as that can make you identifiable (fingerprinting).

**This should work with the following on a regular browser**
...
iHUEARYKAB0WIQSqMaHvdxncX6eJu/uujDIK2tNKXwUCaaTNzQAKCRCujDIK2tNK
X9adAP9Y+AG5km/K8lQgVLNFJfpa+PSfkHedq2T5anHHIm8Z/AD/SxcFYZx29ePP
oKzw+9fP8UaJINjA1wPfCr40swNFGg8=
=EJ9f
-----END PGP SIGNATURE-----
