...
| **Jobs** | Resume Indeed | [Indeed for employers](https://resumes.indeed.com/) | Look for peoples resumes in indeed | a full check cost a monthly sub, is expensive. Will need at least totp (keepassxc) |
